...
function MyApp({ Component, pageProps }) {
  // TODO: Use different image for photos site
  ...
  return (
    <>
      <GlobalStyle />
      <Head>
        <title>Photos - Evan Bonsignori</title>
        <meta
          name="description"
          content="Photography website of Evan Bonsignori"
        />
        <link rel="icon" href="/favicon.ico" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Photos - Evan Bonsignori" />
